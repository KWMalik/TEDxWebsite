(function($) {
  ...
  $.fn.tweet = function(o){
    var s = $.extend({
      username: ["TEDxColumbiaEng"],            // [string]   required, unless you want to display our tweets. 
      list: null,                               // [string]   optional name of list belonging to username
      favorites: false,                         // [boolean]  display the user's favorites instead of his tweets
      avatar_size: null,                        // [integer]  height and width of avatar if displayed (48px max)
      count: 20,                                 // [integer]  how many tweets to display?
      fetch: 50 ,                              // [integer]  how many tweets to fetch via the API (set this higher than 'count' if using the 'filter' option)
      ...
      twitter_url: "twitter.com/TEDxColumbiaEng",               // [string]   custom twitter url, if any (apigee, etc.)
